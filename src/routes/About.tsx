    ...
    <>
        ...
        <Main styleProp="flex-col">
            ...
            <p className={ styles.about }>
                ...
                building Progressive Web Applications which are responsive, performant, and
                accessible. Continuous Delivery is my coding mantra and TDD the means to
                programatic enlightenment.
            </p>
            <p className={ styles.about }>
                I'm currently looking for opportunities to join an awesome team that
                can help me grow as a developer.
            </p>
            <p className={ styles.about }>Learn more about what I do:</p>
            <div className={ styles.links }>
                <a href="#tech-stack" className={ styles.link } onClick={ pingStack }>Tech Stack</a>
...
const styles = {
    ...
    profile: "flex flex-col justify-center items-center sm:flex-row sm:justify-start mx-4 my-6",
